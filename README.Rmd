...
- **Focal predictors** ($x_1$, $x_2$, ...) or **responses** ($y_1$, $y_2$, ...) vary systematically.
...
We also provide some interface from other packages for plotting result model(s), e.g., `br_show_forest_ggstats()`, `br_show_forest_ggstatsplot()`, `br_show_fitted_line()`,
