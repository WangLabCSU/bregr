...
- [`br_get_model_stats()`](https://wanglabcsu.github.io/bregr/reference/br_get_model_stats.md)
  **\[experimental\]** : Get model-level statistics in tidy format
...
Identify cancer prognosis target genes from expression data without
control samples. Four-step pipeline: screening, enrichment,
Lasso/multivariate/stepwise selection, and risk model construction.

- [`br_seed()`](https://wanglabcsu.github.io/bregr/reference/br_seed.md)
  **\[experimental\]** : Run the full SEED gene selection pipeline
- [`br_seed_screen()`](https://wanglabcsu.github.io/bregr/reference/br_seed_screen.md)
  **\[experimental\]** : Screen genes via univariate regression
- [`br_seed_select()`](https://wanglabcsu.github.io/bregr/reference/br_seed_select.md)
  **\[experimental\]** : Select genes via Lasso -\> multivariate -\>
  stepwise regression
- [`br_seed_model()`](https://wanglabcsu.github.io/bregr/reference/br_seed_model.md)
  **\[experimental\]** : Build a risk score model from selected genes
